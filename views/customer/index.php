...
<?php echo form_open('customer/delete','id="actions"') ?>
<table id='customer_list' class="pretty">
    <thead>
        <tr>
            <th>Id</th>
            <th>Customer</th>
...
<?php foreach ($customers as $customer_item): ?>
        <tr>            
            ...
            <td>
                <a href="<?php echo site_url();?>/customer/view/<?php echo $customer_item['id']?>">View</a>
                <a href="<?php echo site_url();?>/customer/edit/<?php echo $customer_item['id']?>">Edit</a>
                <a href="<?php echo site_url();?>/customer/delete/<?php echo $customer_item['id']?>">Delete</a>
                <!--<input type="button" value="delete" onClick="checkDelete()">-->
            </td>
        </tr>
<?php endforeach;?>

<a href="<?php echo site_url();?>/customer/create">Create customer</a>
